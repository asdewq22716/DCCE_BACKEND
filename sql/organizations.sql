...
CREATE TABLE organizations (
    ...
    permission_is_active INT2 DEFAULT 1,
...
COMMENT ON COLUMN organizations.permission_is_active IS 'สถานะการใช้งานสิทธิ์ของหน่วยงาน (1 = เปิด, 0 = ปิดชั่วคราว)';
COMMENT ON COLUMN organizations.permission_remark IS 'หมายเหตุเกี่ยวกับการตั้งค่าสิทธิ์ของหน่วยงานนี้';
...
--
-- วันที่ดำเนินการ: 25 พฤษภาคม 2569 (25 May 2026) - เพิ่มฟิลด์ตั้งค่าสิทธิ์ให้ระดับหน่วยงาน
-- ALTER TABLE organizations ADD COLUMN IF NOT EXISTS permission_is_active INT2 DEFAULT 1;
-- ALTER TABLE organizations ADD COLUMN IF NOT EXISTS permission_remark TEXT;
-- COMMENT ON COLUMN organizations.permission_is_active IS 'สถานะการใช้งานสิทธิ์ของหน่วยงาน (1 = เปิด, 0 = ปิดชั่วคราว)';
-- COMMENT ON COLUMN organizations.permission_remark IS 'หมายเหตุเกี่ยวกับการตั้งค่าสิทธิ์ของหน่วยงานนี้';
